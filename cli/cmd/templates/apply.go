...
func (cmd *ApplyTemplateCmd) Run(ctx context.Context) error {
	templateDir := filepath.Join(cc.GetEameraldTemplateDir(), cmd.Name)
...
func (cmd *ApplyTemplateCmd) setManifest(ctx context.Context) error {
	manifestDir := filepath.Join(cc.GetEameraldTemplateDir(), cmd.Name, "model")
...
func (cmd *ApplyTemplateCmd) importData(ctx context.Context) error {
	dataDir := filepath.Join(cc.GetEameraldTemplateDir(), cmd.Name, "data")
...
func (cmd *ApplyTemplateCmd) execAssertions(ctx context.Context) error {
	assertionsDir := filepath.Join(cc.GetEameraldTemplateDir(), cmd.Name, "assertions")
