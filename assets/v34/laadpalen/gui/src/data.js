...
export const ADRESSEN = [
  { postcode: "1111AA", huisnummer: 1, label: "1111AA 1 (laadpaal aanwezig)" },
  { postcode: "1111DD", huisnummer: 4, label: "1111DD 4 (geen EV)" },
  { postcode: "1111BB", huisnummer: 2, label: "1111BB 2 (vrij adres)" },
  { postcode: "1111EE", huisnummer: 5, label: "1111EE 5 (diplomatiek)" },
  { postcode: "9999ZZ", huisnummer: 99, label: "9999ZZ 99 (onbekend)" },
];
