...
type Config struct {
	Host      string            `flag:"host" short:"H" default:"${directory_svc}" env:"EAMERALD_DIRECTORY_SVC" help:"directory service address"`
	APIKey    string            `flag:"api-key" short:"k" default:"${directory_key}" env:"EAMERALD_DIRECTORY_KEY" help:"directory API key"`
	Token     string            `flag:"token" default:"${directory_token}" env:"EAMERALD_DIRECTORY_TOKEN" help:"directory OAuth2.0 token" hidden:""`
	...
	Headers   map[string]string `flag:"headers" env:"EAMERALD_DIRECTORY_HEADERS" help:"additional headers to send to the directory service"`
